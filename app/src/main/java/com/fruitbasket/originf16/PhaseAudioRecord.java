...
public class PhaseAudioRecord {
    public class WavAudioRecord{//初始设置
    ...
    public void initRecord(){
        ...
        recorder = new AudioRecord(stWavAudioRecord.audioSource,
                ...
                stWavAudioRecord.audioFormat, bufferSize*10);//初始化录音对象
...
//停止的时候才写入
    public void stopRecording() throws IOException {
        ...
        if(GlobalConfig.bSaveWavFile) {//一个是AutoRecording，一个是ProxyRecording
            ...
            int bufferSize = AudioRecord.getMinBufferSize(stWavAudioRecord.sampleRateInHz,
                    stWavAudioRecord.channelConfig, stWavAudioRecord.audioFormat);//获得buffer长度
            //为什么分两个文件？
